...
public class BancoDeDados {
    ...
    public BancoDeDados(){
        ...
        categorias = tranformarLinhasEmObjetos(linhas);
    ...
    public ArrayList<Categoria> tranformarLinhasEmObjetos(ArrayList<String> linhas){
    ...
    public void adicionarDados(Item item, int codigoCategoria){
        try {
            ...
            if (codigoCategoria == 0){
                ...
                linha = item.getNome()+","+item.getPreco()+",Limpeza";
                bw.write(linha);
                bw.newLine();
            }
            ...
            System.out.println("Não consegui adicionar os dados ao arquivo!");
        }
    }
}
